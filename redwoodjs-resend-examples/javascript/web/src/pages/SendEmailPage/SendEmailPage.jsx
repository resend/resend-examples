...
const SendEmailPage = () => {
  ...
  return (
    <>
      <MetaTags title="Send Email" description="Send a basic email" />
      ...
      <form onSubmit={handleSubmit} style={{ display: "grid", gap: "16px" }}>
        ...
        <div>
          ...
          <input id="subject" name="subject" placeholder="Hello from RedwoodJS" required style={inputStyle} />
        </div>
        <div>
          <label htmlFor="message" style={labelStyle}>Message</label>
          <textarea id="message" name="message" placeholder="Your email message..." required rows={4} style={inputStyle} />
        </div>
