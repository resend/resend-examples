...
const TemplatesPage = () => {
  ...
  return (
    <>
      <MetaTags title="Templates" description="Send email with template" />
      ...
      <form onSubmit={handleSubmit} style={{ display: "grid", gap: "16px" }}>
        ...
        <div>
          ...
          <input id="subject" name="subject" placeholder="Email from Template" style={inputStyle} />
        </div>
      ...
      <div style={codeBlockStyle}>
        ...
        <pre style={preStyle}>{`// Set RESEND_TEMPLATE_ID in your .env
