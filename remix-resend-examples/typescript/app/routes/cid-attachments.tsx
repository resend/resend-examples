...
export const meta: MetaFunction = () => {
  return [{ title: "CID Attachments - Remix + Resend" }];
};
...
export default function CidAttachments() {
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Send an email with an inline image using Content-ID. The image is referenced in the HTML via cid:logo."
      />
      ...
      <fetcher.Form method="post" style={{ display: "grid", gap: "16px" }}>
        ...
        <div>
          ...
          <input
            id="subject"
            name="subject"
            defaultValue="Email with Inline Image"
            style={inputStyle}
          />
        </div>
        <button type="submit" style={buttonStyle}>
          {fetcher.state === "submitting" ? "Sending..." : "Send with CID Image"}
        </button>
      </fetcher.Form>
  ...
  html: '<img src="cid:logo" alt="Logo" /> <p>Hello!</p>',
  attachments: [
    {
      filename: "logo.png",
