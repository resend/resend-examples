<script lang="ts">
  ...
  let to = $state("");
  let subject = $state("Scheduled email");
  let html = $state("<p>This email was scheduled!</p>");
...
<PageHeader
  title="Scheduling"
  description="Schedule emails for future delivery using Resend."
/>
...
<form onsubmit={handleSubmit} class="form">
  ...
  <div class="field">
    ...
    <input id="scheduledAt" type="datetime-local" bind:value={scheduledAt} required />
  </div>
...
<details class="code-example">
  ...
  <pre><code>{`// src/routes/api/send-scheduled/+server.ts
