# Nuxt + Resend Examples

Full-stack examples of sending emails using [Resend](https://resend.com) with [Nuxt 3](https://nuxt.com).

Each variant is a complete Nuxt 3 application with server API routes and Vue 3 pages.
