...
function DoubleOptinPage() {
  ...
  return (
    <main style={{ maxWidth: 640, margin: '0 auto', padding: '48px 16px' }}>
      ...
      {result && (
        <div style={{ marginTop: 24, padding: 16, borderRadius: 8, border: '1px solid', borderColor: (result as { error?: string }).error ? '#fca5a5' : '#86efac', background: (result as { error?: string }).error ? '#fef2f2' : '#f0fdf4' }}>
