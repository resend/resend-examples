# TanStack Start + Resend Examples

Full-stack examples of sending emails using [Resend](https://resend.com) with [TanStack Start](https://tanstack.com/start).

Each variant is a complete TanStack Start application with API routes and page routes.
...
- `POST /api/send-batch` - Batch send emails
